...
# DXO tags
DXO_TAGS = {
    0x0007: ('Is MakerNote Loaded', ),
    0x0009: ('Color Space', ),
    0x000a: ('MakerNote Byte Order', ),
    0x000b: ('Raw Bayer Grid', ),
    0x000c: ('Raw Bayer Phase', ),
    0x000d: ('Raw Native Data Precision', ),
	0x000e: ('TIFF Native Data Precision', ),
    0x0012: ('MakerNote Data Offset', ),
    0x0013: ('WhiteBalance Mode', ),
    0x0014: ('WhiteBalance Scales', ),
    0x0018: ('Body ID', ),
    0x002D: ('Noise Reduction', ),
    0x002E: ('Sharpen', ),
    0x002F: ('Black Levels', ),
    0x0035: ('ISO', ),
	0x003C: ('Extra Frame', ),
